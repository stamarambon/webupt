    ...
    <li class="nav-item">
        ...
        <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="SPT.php"><i class="fa fa-folder" aria-hidden="true"></i>
                    SPT</a>
                <a class="collapse-item" href="suratlain.php"><i class="fa fa-envelope" aria-hidden="true"></i> Surat Lainnya</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="cuti.php"><i class="fa fa-calendar-minus" aria-hidden="true"></i>
                    Cuti</a>
                <a class="collapse-item" href="cutiGanti.php"><i class="fa fa-calendar-plus" aria-hidden="true"></i> Pengganti Cuti</a>
            </div>
        </div>
    </li>
