...
<br>
                <h2 style="color: navy;">Permintaan Informasi dan Jasa anda sudah terkirim. Mohon menunggu sementara kami memeriksa ketersediaan informasi dan memverifikasi berkas anda. </h2>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
"></p>
                ...
                <h2 style="color: navy;">Verifikasi berkas permintaan informasi telah selesai dan tersedia. Dimohon melakukan pembayaran terlebih dahulu untuk melanjutkan pelayanan informasi dan jasa. </h2>
...
"></p>
                ...
                <h2 style="color: navy;">Verifikasi berkas permintaan informasi telah selesai dan tersedia. Dimohon menunggu sementara kami mengerjakan pengolahan informasi dan jasa. </h2>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
"></p>
                ...
                <h2 style="color: red;">Verifikasi berkas permintaan informasi telah selesai. Pelayanan informasi dan jasa anda tidak dapat dilanjutkan.</h2>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
"></p>
                ...
                <h2 style="color: navy;">Terima kasih telah melakukan pembayaran. Dimohon menunggu sementara kami mengerjakan pengolahan informasi dan jasa.</h2>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
            </div>
...
"></p>
                ...
                <h2 style="color: navy;">Permintaan informasi dan jasa telah selesai. Silahkan unduh informasi di bawah ini.</h2>
<br>
...
<div class="card-header1" style="
    border-radius: 10px;
">
                    <h4>Halo, <?php echo $data['nama_lengkap'];?><a href="logout.php"><button type="button" class="btn btn-primary float-end" data-bs-toggle="modal" data-bs-target="#" style="
...
">Daftar Permintaan Informasi dan Jasa
                ...
                <div class="card-body">
                            ...
                            <?php
                            require 'dbcon.php';
                            $query = "SELECT * FROM students WHERE `course` = '$data[nama_lengkap]' ORDER BY id DESC";
