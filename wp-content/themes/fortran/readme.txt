=== Fortran ===
Contributors: ggg
Tags: ggg, ggg, gray, green, tan, white,
...
1. Upload the `fortran` folder to the `/wp-content/themes/` directory

Installation using "Add New Theme"

1. From your Admin UI (Dashboard), use the menu to select Themes -> Add New
2. Search for 'fortran'
...
http://www.onedesigns.com/support/forum/theme-support/fortran
